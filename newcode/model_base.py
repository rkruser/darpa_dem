...
class ModelCollection:
    def __init__(self, **kwargs):
        self.models = AttrDict(**kwargs.get('models',{}))
        self.model_folders = AttrDict(**kwargs.get('model_paths',{}))
        self.optimizers = AttrDict(**kwargs.get('optimizers',{}))
        self.criteria = AttrDict(**kwargs.get('criteria',{}))
        self.trackers = AttrDict(**kwargs.get('trackers', {}))
        self.opts = AttrDict(**kwargs.get('opts',{}))
...
#        self.current_state = None
    ...
    def evaluate_and_update(self, x, **opts):
        return self.evaluate_and_update_func(x, self.models, self.optimizers, 
                                             self.criteria, self.trackers, **opts)
